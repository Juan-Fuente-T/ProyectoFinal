...
*/
    ...
    function getBTC_ETHPrice() public view returns (uint256) {
        (, int256 btc_ethPrice, , , ) = registry.latestRoundData(
            btcContractAddress,
            ethContractAddress
        );
    ...
    function getETH_BTCPrice() public view returns (uint256) {
        (, int256 eth_btcPrice, , , ) = registry.latestRoundData(
            ethContractAddress,
            btcContractAddress
        );
    ...
    function getLINK_ETHPrice() public view returns (uint256) {
        (, int256 link_ethPrice, , , ) = registry.latestRoundData(
            linkContractAddress,
            ethContractAddress
        );
    ...
    function getETH_LINKPrice() public view returns (uint256) {
        (, int256 eth_linkPrice, , , ) = registry.latestRoundData(
            ethContractAddress,
            linkContractAddress
        );
    ...
    function getUSDT_ETHPrice() public view returns (uint256) {
        (, int256 usdt_ethPrice, , , ) = registry.latestRoundData(
            usdtContractAddress,
            ethContractAddress
        );
    ...
    function getETH_USDTPrice() public view returns (uint256) {
        (, int256 eth_usdtPrice, , , ) = registry.latestRoundData(
            ethContractAddress,
            usdtContractAddress
        );
    ...
    function getADA_ETHPrice() public view returns (uint256) {
        (, int256 ada_ethPrice, , , ) = registry.latestRoundData(
            adaContractAddress,
            ethContractAddress
        );
    ...
    function getETH_ADAPrice() public view returns (uint256) {
        (, int256 eth_adaPrice, , , ) = registry.latestRoundData(
            ethContractAddress,
            adaContractAddress
        );
