...
contract LendingPoolMalTest is Test {
    IaToken weth;
    IaToken wbtc;
    IaToken wlink;
    IaToken wusdt;
    ...
    function testLendingPool() public {
        ...
        console.log(
            "Fondos Alice BTC ANT",
            lendingPoolTest.balanceOf(alice, 1)
        );
        wbtc.approve(address(lendingPoolTest), 100 ether);
        lendingPoolTest.deposit(1, 100 ether);
        console.log(
            "Fondos Alice BTC DES",
            lendingPoolTest.balanceOf(alice, 1)
        );

        console.log(
            "Fondos Alice Link ANT:",
            lendingPoolTest.balanceOf(alice, 2)
        );
        ...
        console.log(
            "Fondos Alice Link DES:",
            lendingPoolTest.balanceOf(alice, 2)
        );

        console.log(
            "Fondos Alice Usdt ANT:",
            lendingPoolTest.balanceOf(alice, 3)
        );
        ...
        console.log(
            "Fondos Alice Usdt DES:",
            lendingPoolTest.balanceOf(alice, 3)
        );

        console.log(
            "Fondos Alice Ada ANT :",
            lendingPoolTest.balanceOf(alice, 4)
        );
        wada.approve(address(lendingPoolTest), 100 ether);
        lendingPoolTest.deposit(4, 100 ether);
        console.log(
            "Fondos Alice Ada DES:",
            lendingPoolTest.balanceOf(alice, 4)
        );
        ...
        console.log(
            "Alice's balance antes PROBLEMA: ",
            lendingPoolTest.balanceOf(alice, 0)
        );
        ...
        console.log(
            "Alice's balance ETH antes ASSERT FALLO: ",
            lendingPoolTest.balanceOf(alice, 0)
        );
        ...
        console.log(
            "totalSupply BTC ANTES borrow:",
            lendingPoolTest.totalSupply(1)
        );
        console.log(
            "totalSupply ADA ANTES borrow:",
            lendingPoolTest.totalSupply(4)
        );
        ...
        console.log(
            "AmountCollateral borrow: ",
            lendingPoolTest.getAmountCollateral()
        );
        ...
        assertEq(1150000000000000000000, lendingPoolTest.totalSupply(0));
        console.log(
            "Collateral alice borrow 1: ",
            lendingPoolTest.getCollateral(alice, 1)
        );
        assertEq(6000000000000000000, lendingPoolTest.getCollateral(alice, 1));
        console.log(
            "Collateral alice borrow 4: ",
            lendingPoolTest.getCollateral(alice, 4)
        );
        ...
        console.log(
            "Alice's balance despues borrow: ",
            lendingPoolTest.balanceOf(alice, 0)
        );
        console.log(
            "Alice's colateral para BTC despues borrow: ",
            lendingPoolTest.getCollateral(alice, 1)
        );
        console.log(
            "Alice's colateral para ADA despues borrow: ",
            lendingPoolTest.getCollateral(alice, 4)
        );
        console.log(
            "AmountCollateral: ",
        ...
        console.log(
            "Alice's deuda BTC despues borrow: ",
            lendingPoolTest.getDebt(alice, 1)
        );
        console.log(
            "Alice's deuda ADA despues borrow: ",
            lendingPoolTest.getDebt(alice, 4)
        );
        console.log(
            "totalSupply ETH despues borrow:",
            lendingPoolTest.totalSupply(0)
        );
        console.log(
            "totalSupply BTC despues borrow:",
            lendingPoolTest.totalSupply(1)
        );
        console.log(
            "totalSupply ADA despues borrow:",
            lendingPoolTest.totalSupply(4)
        );
        ...
        console.log(
            "Alice's deuda ETH despues borrow2: ",
            lendingPoolTest.getDebt(alice, 0)
        );
        console.log(
            "Alice's deuda ADA despues borrow2: ",
            lendingPoolTest.getDebt(alice, 4)
        );
        console.log(
            "totalSupply ETH despues borrow2:",
            lendingPoolTest.totalSupply(0)
        );
        console.log(
            "totalSupply BTC despues borrow2:",
            lendingPoolTest.totalSupply(1)
        );
        console.log(
            "totalSupply ADA despues borrow2:",
            lendingPoolTest.totalSupply(4)
        );
        console.log(
            "totalSupply USDT despues borrow2:",
            lendingPoolTest.totalSupply(3)
        );
        console.log(
            "totalSupply LINK despues borrow2:",
            lendingPoolTest.totalSupply(2)
        );
        console.log(
            "Balance Alice BTC despues borrow2:",
            lendingPoolTest.balanceOf(alice, 1)
        );
        console.log(
            "Balance Alice LINK despues borrow2:",
            lendingPoolTest.balanceOf(alice, 2)
        );
        console.log(
            "totalSupply USDT despues borrow2:",
        ...
        console.log(
            "Balance ALICE ADA despues borrow2:",
            lendingPoolTest.balanceOf(alice, 4)
        );
        console.log(
            "Alice's deuda LINK despues borrow2: ",
            lendingPoolTest.getDebt(alice, 2)
        );
        console.log(
            "Alice's colateral LINK despues borrow2: ",
            lendingPoolTest.getCollateral(alice, 2)
        );
        console.log(
            "Alice's deuda usdt despues borrow2: ",
            lendingPoolTest.getDebt(alice, 3)
        );
        console.log(
            "Alice's colateral usdt despues borrow2: ",
            lendingPoolTest.getCollateral(alice, 3)
        );
        console.log(
            "PruebaUpdatePrincipalETH",
            lendingPoolTest.updatePrincipal(0)
        );
