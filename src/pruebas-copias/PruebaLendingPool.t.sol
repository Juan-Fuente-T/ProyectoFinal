...
import {PruebaLendingPool} from "./PruebaLendingPool.sol";
...
contract PruebaLending_PoolTest is Test {
    ...
    function testPruebaLendingPool() public {
        ...
        console.log(
            ...
            pruebaLendingPoolTest.balanceOf(alice, 0)
        );
        ...
        console.log("Underlying. BTC", pruebaLendingPoolTest.getUnderlying(1));
        console.log("Underlying. LINK", pruebaLendingPoolTest.getUnderlying(2));
        console.log("Underlying. USDT", pruebaLendingPoolTest.getUnderlying(3));
        ...
        weth.approve(address(pruebaLendingPoolTest), 100000 ether);
        pruebaLendingPoolTest.deposit(0, 100 ether);
        pruebaLendingPoolTest.withdraw(0, 10 ether);

        wbtc.approve(address(pruebaLendingPoolTest), 100000 ether);
        ...
        wlink.approve(address(pruebaLendingPoolTest), 100000 ether);
        pruebaLendingPoolTest.deposit(2, 100000 ether);
        pruebaLendingPoolTest.withdraw(2, 10 ether);
        console.log("SUPPLY_DAI", pruebaLendingPoolTest.totalSupply(2));

        wusdt.approve(address(pruebaLendingPoolTest), 100000 ether);
        pruebaLendingPoolTest.deposit(3, 100000 ether);
        pruebaLendingPoolTest.withdraw(3, 10 ether);

        wdai.approve(address(pruebaLendingPoolTest), 100000 ether);
        pruebaLendingPoolTest.deposit(4, 100000 ether);
        ...
        console.log(
            "Link en Usdc",
            pruebaLendingPoolTest.getConvertedValue(2, 3)
        );
        console.log(
            "Eth en Btc",
            pruebaLendingPoolTest.getConvertedValue(0, 1)
        );
        console.log(
            "Btc en Link",
            pruebaLendingPoolTest.getConvertedValue(1, 2)
        );
        console.log(
            "Btc en Dai",
            pruebaLendingPoolTest.getConvertedValue(1, 4)
        );
        console.log(
            "Dai en Eth",
            pruebaLendingPoolTest.getConvertedValue(4, 0)
        );
        console.log(
            "Usdc en Btc",
            pruebaLendingPoolTest.getConvertedValue(3, 1)
        );
        console.log(
            "Link en Usdc",
            pruebaLendingPoolTest.getConvertedValue(2, 3)
        ...
        console.log(
            "Dai en Btc",
            pruebaLendingPoolTest.getConvertedValue(4, 1)
        );
        console.log(
            "Usdc en Eth",
            pruebaLendingPoolTest.getConvertedValue(3, 0)
        );
        console.log(
            "Eth en Link",
            pruebaLendingPoolTest.getConvertedValue(0, 2)
        );
        console.log(
            "Link en Ether",
            pruebaLendingPoolTest.getConvertedValue(2, 0)
        );
        ...
        pruebaLendingPoolTest.borrow(1, 3, 0.1 ether); //2
        console.log("LoanCounter", pruebaLendingPoolTest.getLoanCounter());
        ...
        //weth.approve(address(pruebaLendingPoolTest), 100);
        //pruebaLendingPoolTest.repay(2, 0, 1208 ether, 0);
